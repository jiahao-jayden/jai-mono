...
type ExtensionErrorInit = {
	...
	readonly operation?: "configuration_read" | "configuration_write" | "approval" | "session_state_read" | "session_state_write";
...
export class CodingExtensionActivationFailed extends TaggedError("coding_extension.activation_failed")<ExtensionErrorInit> {}
export class CodingExtensionCatalogDiscoveryFailed extends TaggedError("coding_extension.catalog_discovery_failed")<
	ExtensionErrorInit
> {}
export class CodingExtensionCapabilityConflict extends TaggedError("coding_extension.capability_conflict")<ExtensionErrorInit> {}
export class CodingExtensionContractViolation extends TaggedError("coding_extension.contract_violation")<ExtensionErrorInit> {}
export class CodingExtensionConfigurationUnavailable extends TaggedError("coding_extension.configuration_unavailable")<
	ExtensionErrorInit
> {}
export class CodingExtensionSessionStateUnavailable extends TaggedError("coding_extension.session_state_unavailable")<
	ExtensionErrorInit
> {}
...
export class CodingExtensionApprovalAborted extends TaggedError("coding_extension.approval_aborted")<ExtensionErrorInit> {}
export class CodingExtensionHostOperationFailed extends TaggedError("coding_extension.host_operation_failed")<ExtensionErrorInit> {}
export class CodingExtensionHookFailed extends TaggedError("coding_extension.hook_failed")<ExtensionErrorInit> {}
export class CodingExtensionDeactivationFailed extends TaggedError("coding_extension.deactivation_failed")<ExtensionErrorInit> {}
