...
export function StreamingPlaceholder() {
	return (
		<MessageAssistant>
			<motion.div className="py-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
...
export function ErrorBlock({ children }: { children: React.ReactNode }) {
	return (
		...
		>
			<span aria-hidden className="absolute inset-y-1.5 left-0 w-0.5 rounded-full bg-destructive/70" />
