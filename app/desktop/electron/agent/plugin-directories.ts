...
export interface DesktopAgentPluginDirectory {
	readonly path: string;
	readonly scope: "user" | "project";
}

export interface DesktopAgentPluginDirectoryDiscoveryOptions {
...
export async function discoverDesktopAgentPluginDirectories(
	options: DesktopAgentPluginDirectoryDiscoveryOptions,
): Promise<readonly DesktopAgentPluginDirectory[]> {
