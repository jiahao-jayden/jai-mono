...
import { CodingConfigStore, type CodingConfigStoreOptions, type ConfigWatchEvent } from "./store";
import { type CodingAgentSettings, desktopCodingConfigDefinition } from "./coding-settings";

export type DesktopConnectorConfigStoreOptions = CodingConfigStoreOptions;

export function createDesktopConnectorConfigStore(
	options: DesktopConnectorConfigStoreOptions = {},
): ConnectorConfigStore {
	return new DesktopConnectorConfigStore(new CodingConfigStore(desktopCodingConfigDefinition, options));
}

class DesktopConnectorConfigStore implements ConnectorConfigStore {
	constructor(private readonly codingStore: CodingConfigStore<typeof desktopCodingConfigDefinition.schema>) {}
...
function toConnectorSnapshot(
	snapshot: Awaited<ReturnType<CodingConfigStore<typeof desktopCodingConfigDefinition.schema>["load"]>>,
...
function toConnectorWatchEvent(event: ConfigWatchEvent<typeof desktopCodingConfigDefinition.schema>) {
