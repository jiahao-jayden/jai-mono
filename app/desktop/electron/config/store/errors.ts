...
class ConfigDefinitionInvalid extends TaggedError("desktop_config.definition_invalid")<ConfigErrorInit> {}
class ConfigReadFailed extends TaggedError("desktop_config.read_failed")<ConfigErrorInit> {}
class ConfigParseFailed extends TaggedError("desktop_config.parse_failed")<ConfigErrorInit> {}
class ConfigValidationFailed extends TaggedError("desktop_config.validation_failed")<ConfigErrorInit> {}
class ConfigUnsupportedVersion extends TaggedError("desktop_config.unsupported_version")<ConfigErrorInit> {}
class ConfigMigrationFailed extends TaggedError("desktop_config.migration_failed")<ConfigErrorInit> {}
class ConfigWriteConflict extends TaggedError("desktop_config.write_conflict")<ConfigErrorInit> {}
class ConfigWriteFailed extends TaggedError("desktop_config.write_failed")<ConfigErrorInit> {}
class ConfigWatchFailed extends TaggedError("desktop_config.watch_failed")<ConfigErrorInit> {}
class ConfigScopeUnavailable extends TaggedError("desktop_config.scope_unavailable")<ConfigErrorInit> {}
