export interface OAuthGatewayService {
	...
	/** The fixed callback registered with the upstream Service. */
	...
	/** Service-specific authorization parameters, for example Google's offline-access request. */
	readonly authorizationParams?: Readonly<Record<string, string>>;
}

export interface OAuthGatewayOptions {
	readonly services: readonly OAuthGatewayService[];
