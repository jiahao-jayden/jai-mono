...
import { createAMapAdapter, createContext7Adapter, createMcDonaldsCnAdapter } from "../src/providers";
...
describe("Connector generated action catalog", () => {
	test("matches the public Provider Adapter Action IDs", async () => {
		...
		const adapters = [createContext7Adapter(), createAMapAdapter(), createMcDonaldsCnAdapter()];
