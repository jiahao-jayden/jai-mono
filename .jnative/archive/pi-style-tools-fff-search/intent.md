...
- Pi 与 `@ff-labs/pi-fff` 的工具名、参数、默认 mode 与本地状态行为见[调研](../../research/tools/pi-fff-tool-contract.md)；native package 分发与 ABI 仍需在 Spec 01 的真实 smoke test 中钉死，避免以转述决定公共 API。
